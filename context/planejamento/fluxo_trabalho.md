...
- 🔴 **Bloqueante** — precisa estar pronto antes de avançar
- 🟡 **Paralelo** — pode rodar junto com outras etapas
- 🟢 **Livre** — pode ser feito a qualquer momento

---

## Fase 1 — Fundação
> Todas as etapas dessa fase são bloqueantes. Nada avança sem elas.
...
> Pode rodar em paralelo após a Fase 1 estar concluída.
...
## Fase 3 — Conteúdo
> Pode rodar em paralelo com a Fase 2.
...
> Pode rodar em paralelo com as Fases 2 e 3.
...
## Fase 5 — Ativação
> Só inicia após Fases 1, 2, 3 e 4 concluídas.
...
├── 1.1 Manual da Marca
└── 1.2 Validação Jurídica

        ↓

FASE 2 + 3 + 4 — Rodam em paralelo
├── 2.1 Site
├── 2.2 Perfis LinkedIn e Instagram
├── 2.3 Selo Azul (iniciar logo)
├── 3.1 Blog Posts
├── 3.2 Pré-popular LinkedIn
├── 3.3 Pré-popular Instagram
├── 3.4 Conteúdo recorrente
├── 4.1 Pixel Meta
├── 4.2 Funil Email Marketing
├── 4.3 Funil LinkedIn
